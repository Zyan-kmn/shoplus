<?php  session_start(); ?>
				...
				<div class="dropdown d-inline-block">
				  ...
				  <?php 
            		...
            		<?php endforeach; ?>
				    	...
				    	<li><a class="dropdown-item" href="subcategory.php?sid=<?= $sid  ?>&&cid=<?=$cid?>&&bid=<?=$bid?> "><?= $sname; ?></a></li>
				              <?php endforeach; ?>
  ...
  <a class="text-decoration-none text-dark font-weight-bold" href="javascript:void(0)" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<div class="collapse sidebardropdown_container_category mt-3" id="category">  <?php 
