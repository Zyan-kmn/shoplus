			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	 <a href="frontenditemdetail.php?id=<?=$did?>">  <img src="<?= $dphoto ?>" class="img-fluid"></a>
		                        <p class="text-truncate"><?= $dname ?></p>
		                        <p class="item-price">
		                        	
		                        	<span class="d-block"><?= $ddiscount  ?></span>
		                        </p>
								...
								<a href="#" class="addtocartBtn text-decoration-none"
								 data-id="<?= $did?>" 
								 data-name="<?=$dname ?>" data-codeno="<?= $dcodeno ?>" data-photo="<?= $dphoto?>" data-price="<?= $dprice ?>" data-discount="<?=$ddiscount?>">Add to Cart</a>
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		            	...
		            	<?php 
		            		$sql="SELECT * FROM items ORDER BY rand()  limit 7";
                        	$stmt= $conn->prepare($sql);
                        	$stmt->execute();
                        	$items=$stmt->fetchAll();
