    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            <?php 
             ...
             ?>
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="image/kmn.jpg" alt="User Image" style="width: 50px; height:50px;">
                <div>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="customerToday.php">
